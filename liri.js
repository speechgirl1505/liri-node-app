...
function itsShowTime(artistName) {
  ...
  // var showTime1 = moment(response.data[1].datetime).format("MM/DD/YYYY");
  // var showTime2 = moment(response.data[2].datetime).format("MM/DD/YYYY");
  // console.log(
  //   `
  ...
  // Date of Event: ${showTime1}

  // Name of Venue: ${response.data[2].venue.name}
  // Venue Location: ${response.data[2].venue.city}, ${response.data[2].venue.region}
